...
【一】流程状态机：待支付、已支付、待发货、已发货、已收货、售后中、售后完成、待评价、已评价、已完成、待结算、已结算、已关闭。

【二】售后状态机：无售后、申请中、已同意、已拒绝、已退货、已收货、已入库、已退款、已取消、已完成。

【三】支付状态机：未支付、已支付、已退款。

【四】结算状态机：待结算、结算单已创建、平台已核验、商家已核验、结算单已核验、结算单异常、已打款、已确认、已完成。
